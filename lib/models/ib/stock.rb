...
module IB
  class Stock < IB::Contract
    validates_format_of :sec_type, :with => /\Astock\z/, message: "should be a Stock"
    validates_format_of :symbol, with: /\A.*\z/, message: 'should not be blank'
